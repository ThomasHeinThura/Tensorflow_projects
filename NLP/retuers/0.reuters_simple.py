...
model.add(layers.Dense(512, input_shape=[max_vocab_length], activation='relu'))
model.add(tf.keras.layers.Dropout(0.5))
model.add(layers.Dense(46, activation='softmax'))
model.compile(optimizer=tf.keras.optimizers.Adam(), loss='cosine_proximity', metrics=['accuracy'])
